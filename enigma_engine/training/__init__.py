...
is the encoder-align trainer (train_vision + train_audio) used by
align_vision.py / align_audio.py; the live text paths are the bespoke
root scripts (pretrain_enigma.py, finetune_enigma.py, dpo_enigma.py).
...
2026-07-19). Import the trainer as:
